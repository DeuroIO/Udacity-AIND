...
class PositionSearchProblem(search.SearchProblem):
  ...
  def isGoalState(self, state):
     ...
     print('_visitedlist:{}'.format(self._visitedlist))
     print('isGoal:{}'.format(isGoal))
     return isGoal
...
def cornersHeuristic(state, problem):
  ...
  for cor in state[1]:
      largest_distance = max(util.manhattanDistance(cor,state[0]),largest_distance)
  return largest_distance # Default to trivial solution
